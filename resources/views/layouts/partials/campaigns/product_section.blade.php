...
<div class="tab-section product-tab-section">
    <div class="form-group">
        ...
        <div class="selectgroup w-100">
            <label class="selectgroup-item tab-section-btn-2" id="non-video-ad">
                <input wire:model.defer="adType" type="radio" name="ad_type" value="non_video"
            ...
            <label class="selectgroup-item tab-section-btn-2" id="online-video-ad">
                <input wire:model.defer="adType" type="radio" name="ad_type" value="video"
                       class="selectgroup-input">
                <span
            ...
            <label class="selectgroup-item tab-section-btn-2" id="offline-store">
                <input wire:model.defer="adType" type="radio" name="ad_type" value="offline"
                       class="selectgroup-input">
                <span
    ...
    <div class="tab-section non-video-ad-section">
        ...
        <div class="form-group">
            ...
            <input wire:model.defer="link" type="text" class="form-control" >
        ...
        <div class="form-group">
            <label>Brand</label>
            <input wire:model.defer="brand" type="text" class="form-control" >
        ...
        <div class="form-group">
            ...
            <select wire:model.defer="subCategory1" class="form-control" >
                <option value="">Select a category</option>
                <option>Category 1</option>
                <option>Category 2</option>
            </select>
        ...
        <div class="form-group">
            ...
            <select wire:model.defer="subCategory2" class="form-control" >
                <option value="">Select a category</option>
                <option>Category 1</option>
                <option>Category 2</option>
            </select>
        ...
        <div class="form-group">
            ...
            <select wire:model.defer="subCategory3" class="form-control" >
                <option value="">Select a category</option>
                <option>Category 1</option>
                <option>Category 2</option>
            </select>
        ...
        <div class="form-group">
            ...
            <select wire:model.defer="targetAudience" class="form-control" >
                <option value="">Select a category</option>
        ...
        <div class="form-group">
            ...
            <input wire:model.defer="fromAge" type="number" class="form-control" >
            @error('fromAge') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="form-group">
            <label>To Age</label>
            <input wire:model.defer="toAge" type="number" class="form-control" >
        ...
        <div class="form-group">
            ...
            <input wire:model.defer="discountCouponCode" type="text" class="form-control" >
    ...
    <div class="tab-section online-video-ad-section">
        ...
        <div class="form-group">
            <label>Target Audience</label>
            <select class="form-control" wire:model.defer="targetAudience" >
                <option>All Genders</option>
                <option>Male</option>
                <option>Female</option>
            </select>
        ...
        <div class="form-group">
            <label>From Age</label>
            <input type="number" class="form-control" wire:model.defer="fromAge" >
            @error('fromAge') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="form-group">
            <label>To Age</label>
            <input type="number" class="form-control" wire:model.defer="toAge" >
            @error('toAge') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
    ...
    <div class="tab-section offline-store-section">
        ...
        <div class="form-group">
            ...
            <input wire:model.defer="storeName" type="text" class="form-control" name="store_name" >
            @error('storeName') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="form-group">
            <label>Ad campaign name</label>
            <input wire:model.defer="name" type="text" class="form-control" name="store_campaign_name" >
            @error('name') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <strong>Store Location</strong>
        <div class="form-group">
            <label>Address Line 1</label>
            <input wire:model.defer="addressLine1" type="text" class="form-control" >
            @error('addressLine1') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="form-group">
            <label>Address Line 2</label>
            <input wire:model.defer="addressLine2" type="text" class="form-control" >
