<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Draft Ad Campaigns</h2>
        <p class="section-lead">Here you can see draft campaigns.</p>
                            ...
                            <table class="table table-striped table-md">
                                ...
                                @foreach($campaigns as $campaign)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary" wire:click="continue({{$campaign->id}})">Continue</button>
                                        </td>
                                    </tr>
                                @endforeach
