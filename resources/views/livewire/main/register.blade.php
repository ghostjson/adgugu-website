                    ...
                    <form class="form-transparent-grey" >
                                    ...
                                    <div class="col-sm-7 col-md-7">
                                        <div class="input-group">
                                            <div id="role" class="btn-group">
                                                <a id="advertiser-role" class="btn btn-primary btn-sm role-btn " onclick="changeRole('advertiser')" >Advertiser</a>
                                                <a id="promoter-role" class="btn btn-primary btn-sm role-btn notActive" onclick="changeRole('promoter')" >Promoter</a>
                                                <a id="shopper-role" class="btn btn-primary btn-sm role-btn notActive" onclick="changeRole('shopper')">Shopper</a>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <input required type="password"  placeholder="Conform Password" class="form-control">
                            </div>
                            <div class="col-lg-12 form-group">
                                <label class="sr-only">Phone</label>
                                <input required type="text"  placeholder="Phone" class="form-control">
                            </div>
                            <div class="col-lg-12 form-group">
